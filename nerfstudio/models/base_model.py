...
class Model(nn.Module):
    ...
    @abstractmethod
    def get_outputs(self, ray_bundle: RayBundle, output_type: Optional[str] = None) -> Dict[str, torch.Tensor]:
    ...
    def forward(self, ray_bundle: RayBundle, output_type: Optional[str] = None) -> Dict[str, torch.Tensor]:
        ...
        return self.get_outputs(ray_bundle, output_type)
    ...
    @torch.no_grad()
    def get_outputs_for_camera_ray_bundle(self, camera_ray_bundle: RayBundle, output_type: Optional[str] = None) -> Dict[str, torch.Tensor]:
        ...
        for i in range(0, num_rays, num_rays_per_chunk):
            ...
            outputs = self.forward(ray_bundle=ray_bundle, output_type=output_type)
