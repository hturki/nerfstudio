...
class Model(nn.Module):
    ...
    @abstractmethod
    def get_outputs(self, ray_bundle: RayBundle, render_options: Optional[Dict[str, any]] = None) -> Dict[str, torch.Tensor]:
    ...
    def forward(self, ray_bundle: RayBundle, render_options: Optional[Dict[str, any]] = None) -> Dict[str, torch.Tensor]:
        ...
        return self.get_outputs(ray_bundle, render_options)
    ...
    def get_outputs_for_camera_ray_bundle(self, camera_ray_bundle: RayBundle, render_options: Optional[Dict[str, any]] = None) -> Dict[str, torch.Tensor]:
        ...
        for i in range(0, num_rays, num_rays_per_chunk):
            ...
            outputs = self.forward(ray_bundle=ray_bundle, render_options=render_options)
